 ...
 *
 *
 * FRC-649 specific change is that when the setpoint is passed in either
 * direction, the error is reset to 0 - this makes it so that if for any reason,
 * a significant amount of error has accumulated, then overshoot will be less
 * significant, and less likely to break physical components - less ideal, but
 * more realistic
 */
public class PIDController649 implements IUtility, LiveWindowSendable {
    ...
    private double m_errorDiff = 0.0;
    ...
    private class PIDTask extends TimerTask {
        ...
        private PIDController649 m_controller;

        public PIDTask(PIDController649 controller) {
            if (controller == null) {
    ...
    public void setOutputDirection(boolean dir) {
     ...
     * @deprecated Use setTolerance(Tolerance), i.e. setTolerance(new
     * PIDController.PercentageTolerance(15))
     */
